...
\usepackage{minted}
% #endregion
% \includeonly{sections/webhacking}
\begin{document}
\newcounter{points}
\newcounter{unfinished}
...
\include{sections/tig}
\include{sections/netmap}
\include{sections/hash}
\include{sections/getintouch}
\include{sections/webhacking}
\include{sections/pwn}
\newpage
\section*{}
\addcontentsline{toc}{section}{Total points: \arabic{points}p (finished) + \arabic{unfinished}p (unfinished)}
\begin{center}
    \topskip0pt
    \vspace*{\fill}
