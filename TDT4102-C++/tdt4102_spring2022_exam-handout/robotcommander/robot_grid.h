...
{
public:
  RobotGrid(AnimationWindow &window, TracingApplication &application, int x,
  ...
  void clear_robots();
  TracingApplication &get_application();

private:
  // The window we should draw to
  AnimationWindow &window;
  TracingApplication &application;
  ...
  void check_coord_bounds(Point pos) const;
